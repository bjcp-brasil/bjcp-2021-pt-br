...
O termo “IPA” é usado como um descritor singular de um tipo de cerveja lupulada e amarga. No contexto de uma Specialty IPA, ele não deve ser entendido literalmente como “India Pale Ale”. Nenhuma dessas cervejas foi historicamente enviada para a Índia, e muitas delas nem sequer são claras. Mas o mercado de cervejas artesanais sabe o que esperar em termos de equilíbrio quando uma cerveja é descrita como “IPA”; portanto, os modificadores usados para diferenciá-las se baseiam apenas nesse conceito.

A categoria Specialty IPA não se destina a IPAs de estilos clássicos com ingredientes adicionados, como frutas, especiarias, madeira, fumaça, grãos ou açúcares; essas cervejas devem ser inscritas na categoria apropriada de cerveja de tipo especial, como Fruit Beer, SHV Beer etc. Os estilos de Specialty IPA são considerados estilos clássicos para fins de inscrição em categorias de cervejas de tipo especial. IPAs de estilos clássicos com lúpulos únicos ou especiais ainda devem ser inscritas no estilo clássico de IPA apropriado.
