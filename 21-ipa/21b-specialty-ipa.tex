...
\textit{Specialty IPA é uma categoria de inscrição em competição, não um estilo distinto. As cervejas inscritas aqui não são cervejas experimentais; elas representam um conjunto de tipos de cerveja produzidos atualmente, que podem ou não ter longevidade no mercado. Esta categoria também permite expansão, de modo que possíveis variantes futuras de IPA — como St. Patrick’s Day Green IPA, Romulan Blue IPA, Zima Clear IPA etc. — tenham um lugar para serem inscritas sem a necessidade de reescrever as diretrizes de estilo. O único elemento comum é que elas apresentam o equilíbrio e a impressão geral de uma IPA, normalmente uma American IPA, mas com algum pequeno ajuste.}

\textit{O termo “IPA” é usado como um descritor singular de um tipo de cerveja lupulada e amarga. No contexto de uma Specialty IPA, ele não deve ser entendido literalmente como “India Pale Ale”. Nenhuma dessas cervejas foi historicamente enviada para a Índia, e muitas delas nem sequer são claras. Mas o mercado de cervejas artesanais sabe o que esperar em termos de equilíbrio quando uma cerveja é descrita como “IPA”; portanto, os modificadores usados para diferenciá-las se baseiam apenas nesse conceito.}

\textit{A categoria Specialty IPA não se destina a IPAs de estilos clássicos com ingredientes adicionados, como frutas, especiarias, madeira, fumaça, grãos ou açúcares; essas cervejas devem ser inscritas na categoria apropriada de Specialty Beer, como Fruit Beer, SHV Beer etc. Os estilos de Specialty IPA são considerados estilos clássicos para fins de inscrição em categorias de cervejas de tipo especial. IPAs de estilos clássicos com lúpulos únicos ou especiais ainda devem ser inscritas no estilo clássico de IPA apropriado.}
