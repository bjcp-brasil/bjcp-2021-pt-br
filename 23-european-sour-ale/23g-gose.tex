...
\textbf{Comparação de Estilo}: A acidez percebida não é tão intensa como na Berliner Weisse ou na Gueuze. Uso contido de sal, sementes de coentro e Lacto - não deve ter um gosto notadamente salgado. O aroma de sementes de coentro pode ser similar a uma Witbier. Turbidez similar a uma Weissbier.
