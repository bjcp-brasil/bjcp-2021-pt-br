...
\textbf{Impressão Geral}: Uma cerveja de mesa clara, amarga e lupulada, muito seca e altamente carbonatada. O caráter agressivo frutado-condimentado da levedura belga e o alto amargor predominam no equilíbrio, com uma base de malte suave, de apoio, levemente como cereais e adocicado, além de um perfil de lúpulo condimentado-floral.

\textbf{Aroma}: Característica de levedura belga de intensidade média-baixa a média-alta, exibindo um caráter frutado e condimentado em conjunto com um perfil de intensidade média-baixa a média de lúpulo condimentado ou floral, ocasionalmente realçados por toques leves de especiarias herbais ou cítricas. Em segundo plano, o malte é de baixo a médio-baixo, com notas de pão, biscoito, cereais ou mel suave. O frutado pode variar bastante (maçã, pera, toranja, limão, laranja, pêssego, damasco). Fenólicos são tipicamente como pimenta preta ou cravo. Tutti-frutti é inapropriado.
