...
\begin{itemize}
  \item Uma combinação de Estilos Existentes que não estão definidos anteriormente nas diretrizes, incluindo uma combinação de Cervejas de Especialidade que não se enquadram em outras categorias.
...
\textbf{Aroma}: De acordo com os estilos base declarados.

\textbf{Aparência}: De acordo com os estilos base declarados.

\textbf{Sabor}: De acordo com os estilos base declarados.

\textbf{Sensação na Boca}: De acordo com os estilos base declarados.
